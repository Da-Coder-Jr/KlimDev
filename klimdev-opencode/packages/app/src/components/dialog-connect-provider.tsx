        ...
        <Switch>
          <Match when={provider().id === "nvidia"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.nvidia.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.nvidia.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.nvidia.visit.prefix")}
                <Link href="https://klimdev.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.nvidia.visit.link")}
                </Link>
                {language.t("provider.connect.nvidia.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
