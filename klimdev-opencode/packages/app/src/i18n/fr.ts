export const dict = {
  ...
  "dialog.provider.nvidia.note": "NVIDIA NIM models including Llama, Nemotron and more",
  "dialog.provider.nvidia.tagline": "High-performance inference at scale",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par KlimDev",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans KlimDev.",
  ...
  "provider.connect.nvidia.line1":
    "KlimDev Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.nvidia.visit.prefix": "Visitez ",
  "provider.connect.nvidia.visit.link": "klimdev.ai/zen",
  "provider.connect.nvidia.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans KlimDev.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans KlimDev.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans klimdev.json",
  ...
  "dialog.server.description": "Changez le serveur KlimDev auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'KlimDev ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe KlimDev",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (klimdev.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'KlimDev ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "KlimDev inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur KlimDev dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour KlimDev",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'KlimDev sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si KlimDev suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'KlimDev.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'KlimDev",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'KlimDev.",
