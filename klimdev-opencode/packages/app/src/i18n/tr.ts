...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "KlimDev tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve KlimDev'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.nvidia.line1":
    "KlimDev Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.nvidia.visit.prefix": "",
  "provider.connect.nvidia.visit.link": "klimdev.ai/zen",
  "provider.connect.nvidia.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve KlimDev'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak KlimDev'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler klimdev.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi KlimDev sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "KlimDev'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı KlimDev ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (klimdev.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: KlimDev henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "KlimDev ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "KlimDev Masaüstü",
  ...
  "settings.desktop.wsl.description": "KlimDev sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "KlimDev'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "KlimDev'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "KlimDev'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "KlimDev'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "KlimDev başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "KlimDev'un en son sürümünü kullanıyorsunuz.",
